...
import com.example.wando.daystarlaptops.ui.LoginActivity;
...
public class CheckUserLoginThread implements Runnable {
    ...
    private static final String TAG = CheckUserLoginThread.class.getName();

    public CheckUserLoginThread(Handler handler, String userID, String passWord, Context context) {
    ...
    public void run() {
        ...
        AndroidNetworking.post(ApiEndPoint.BASE_URL + ApiEndPoint.GET_USER_ID)
                .setTag(this)
